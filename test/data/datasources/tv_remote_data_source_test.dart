...
import 'package:ditonton/data/datasources/tv_remote_date_source.dart';
...
void main() {
  ...
  group('search tvs', () {
    final tSearchResult = TvResponse.fromJson(
        ...
        .tvList;
    final tQuery = 'game%20of%20thrones';
  ...
  group('get tv season', () {
    final tTvList = TvSeasonModel.fromJson(
        json.decode(readJson('dummy_data/tv_season.json')));
    final tId = 1;
    final tSeasonNumber = 1;

    test('should return list of Tv Season Model when the response code is 200',
        () async {
      // arrange
